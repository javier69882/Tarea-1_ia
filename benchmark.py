...
def ejecutar_benchmark(nombre_algoritmo, funcion_simulacion, tipo_mapa, iteraciones=150):
    ...
    for i in range(iteraciones):
        ...
        # Ejecutamos la simulación en silencio
        with HiddenPrints():
    ...
    with open(archivo_csv, mode='w', newline='') as file:
        ...
        # Cambiamos 'iteraciones' por la longitud real de la lista
